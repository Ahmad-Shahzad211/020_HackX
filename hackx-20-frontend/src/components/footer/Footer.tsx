...
export default function Footer() {
  return (
    <footer className="py-6 px-8 transition-colors duration-300" style={{ background: 'var(--gradient-primary)' }}>
      <div className="flex flex-col md:flex-row justify-between max-w-6xl mx-auto space-y-6 md:space-y-0">
        {/* Left content container */}
        <div className="flex flex-col md:flex-row md:space-x-20 grow text-white">
          {/* Quick Links Section */}
      ...
      {/* Copyright Notice */}
      <div className="max-w-6xl mx-auto mt-8 pt-4 flex justify-center">
